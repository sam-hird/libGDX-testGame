...
public class MainMenu implements Screen {
    ...
    public MainMenu(Game myGame){
        ...
        TextButton playButton = new TextButton("Play!",((MyGame)game).getGameSkin());
        ...
        TextButton optionsButton = new TextButton("Options",((MyGame)game).getGameSkin());
        optionsButton.setWidth(Gdx.graphics.getWidth()/2);
        optionsButton.setHeight(Gdx.graphics.getHeight()/5);
